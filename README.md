...
- `js/boxes/` — los tipos de caja concretos: `simple-box.js` (caja cerrada y tapa plana), `sliding-box.js` (tapa deslizante), `hinged-box.js` (tapa con bisagra), `hinged-double-box.js` (tapa con bisagra doble, reutiliza varios parámetros de `hinged-box.js`) y `shared.js` con lo que todos comparten.
