...
| Tamaño de la espiga (mm) | el grosor del material | Solo con tapa con bisagra. Lado del cuadrado macizo que hace de eje de la bisagra — no un diámetro, un cuadrado. Con "Automático" marcada sigue al grosor del material (una espiga de 3 mm para 3 mm de material). |
| Holgura del agujero (mm) | 1 | Solo con tapa con bisagra. Cuánto más grande se dibuja el agujero que la espiga necesita para girar sin trabarse (el agujero sale de la diagonal de la espiga, no de su lado, porque al girar la espiga barre un círculo del tamaño de esa diagonal). Se calibra con una prueba antes de cortar la caja: dura si es poca, bamboleante si es mucha. |
...
| Profundidad de la manija (mm) | grosor + 5 | Solo con tapa con bisagra. Cuánto sobresale la lengüeta más allá del perímetro de la caja — crece con el grosor del material para que siempre quede cómoda de agarrar. Con "Automática" marcada sigue esa fórmula. |
