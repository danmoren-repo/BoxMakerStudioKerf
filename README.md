...
El archivo tiene dos grupos separados:
- **`#cut`**: los trazos de corte de cada panel (lo que la láser debe cortar).
...
- `js/boxes/` — los tipos de caja concretos (hoy solo la caja cerrada de seis paneles en `simple-box.js`: qué panel es macho/hembra, reglas de validación, ancho de espiga automático).
